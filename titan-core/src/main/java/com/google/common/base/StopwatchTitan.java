 ...
 *     returned by {@code nanoTime} at a different time. {@code StopwatchTitan} is a
 ...
 * <p>Basic usage:
 * <pre>
 *   StopwatchTitan stopwatch = StopwatchTitan.{@link #createStarted createStarted}();
 *   doSomething();
 ...
 *
 * <p>StopwatchTitan methods are not idempotent; it is an error to start or stop a
...
public final class StopwatchTitan {
     ...
     * @since 15.0
     */
    public static StopwatchTitan createUnstarted() {
        return new StopwatchTitan();
    }
     ...
     * @since 15.0
     */
    public static StopwatchTitan createUnstarted(Ticker ticker) {
        return new StopwatchTitan(ticker);
    }
     ...
     * @since 15.0
     */
    public static StopwatchTitan createStarted() {
        return new StopwatchTitan().start();
    }
     ...
     * @since 15.0
     */
    public static StopwatchTitan createStarted(Ticker ticker) {
        return new StopwatchTitan(ticker).start();
    }
     ...
     * as its time source.
     *
     * @deprecated Use {@link StopwatchTitan#createUnstarted()} instead.
     */
    @Deprecated
    public StopwatchTitan() {
     ...
     * source.
     *
     * @deprecated Use {@link StopwatchTitan#createUnstarted(Ticker)} instead.
     */
    @Deprecated
    public StopwatchTitan(Ticker ticker) {
     ...
     *
     * @return this {@code StopwatchTitan} instance
     * @throws IllegalStateException if the stopwatch is already running.
     */
    public StopwatchTitan start() {
    ...
    // DAVID - second this comment for the entire Guava jar file issue
